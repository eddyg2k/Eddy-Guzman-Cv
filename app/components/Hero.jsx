...
/**
 * Hero slide replicates the main CV cover. It uses motion animations and a
 * gradient background to introduce your professional title and availability.
 */
export default function Hero() {
  return (
    <Section id="hero" className="relative isolate overflow-hidden">
      ...
      <div
        className="absolute inset-0 -z-10 bg-gradient-to-b from-white/5 via-transparent to-black"
        aria-hidden
      />
      <motion.div
        aria-hidden
